...
2. Set "Bus Tracker" as the skill name and "CTA" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, ask CTA when is my next bus coming?"
